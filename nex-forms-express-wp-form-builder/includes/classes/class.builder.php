...
if(!class_exists('NEXForms_Builder7')){
	class NEXForms_Builder7{
		...
		public function __construct(){
			...
			if($form_id)
				{
				$this->form_Id = sanitize_title($form_id);
				$this->form_type = sanitize_text_field($form_type);
		...
		public function builder7_top_menu(){
					...
					$output .= '
						<div class="col-sm-12">
						  <div class="help_menu dropdown_menu aa_menu">
								...
								<li class="top-right-item"><a class="btn waves-effect-nf waves-light-nf tours-menu"><span class="fa fa-info-circle"></span></a>
									<ul class="aa_bg_sec aa_menu_2">
						...
						//$output .= '<li class="colapse_fullscreen" style="display:none"><a class="btn waves-effect-nf waves-light-nf btn-wordpress" href="#" data-toggle="tooltip_bs" data-html="true" data-placement="bottom" title="'.__('Exit Fullscreen Mode<br>Show WordPress Menus','nex-forms').'"><span class="fas fa-compress-arrows-alt"></span></a></li>';<span class="fa fa-caret-left" style="font-size: 29px !important;position: relative;top: -6px !important;"></span>
						$output .= '<li class="back-to-dashboard" ><a class="btn waves-effect-nf waves-light-nf btn-dashboard" href="'.get_admin_url().'admin.php?page=nex-forms-dashboard" data-toggle="tooltip_bs" data-placement="bottom" title="'.__('Back to NEX-Forms Dashboard','nex-forms').'"><span class="fa fa-arrow-left" ></span></a></li>';
				...
				$output .= '<div class="nav-content prime-menu">';
						...
						$theme = wp_get_theme();	
								...
								$output.= '<div class="top-menu-dropdown"><ul class="new_tabs_nf sec-menu aa_menu"> 
										...
										<li class="tab  save-menu-item"><div class="save_nex_form prime_save" data-toggle="tooltip_bs2" data-placement="bottom" title="'.__('Save (CTRL+S)','nex-forms').'"><span class="top-icon fas fa-save"></span><span class="menu-text">'.__('SAVE','nex-forms').'</span></div> </li>
										
										<li class="tab  preview-menu-item"><div class="prime-preview preview" data-toggle="tooltip_bs2" data-placement="bottom" title="'.__('Preview Form','nex-forms').'"><span class="top-icon fas fa-eye"></span><span class="menu-text">'.__('PREVIEW','nex-forms').'</span></div> </li>
...
//LABEL SETTINGS //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
		...
		$output .= '<div id="ms-overall-settings-panel" class="ms-settings row settings-section active">';
			...
			$output .= '<div class="field-setting is-settings-header col-xs-12 s-all" style="margin-bottom:25px !important;">';	
								$output .= '<div class="settings-header"><span>'.__('Step Transition Animations','nex-forms').'</span></div>';
							$output .= '</div>';
						...
						$output .= '<div id="ms-timer-settings-panel" class="ms-settings row settings-section" style="display:none;">';
								...
								$output .= '<div class="field-setting col-xs-3 s-all" >';	
									$output .= '<div role="group" class="btn-group timer-direction" data-value="'.$timer_direction.'">';
										...
										$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf anti-clockwise '.(($timer_direction=='anti-clockwise') ? 'active' : '' ).'" type="button" title="'.__('Clockwise','nex-forms').'"><i class="fa fa-clock-rotate-left fa-flip-horizontal"></i></button>';
										$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf clockwise '.(($timer_direction=='clockwise') ? 'active' : '' ).'" type="button" title="'.__('Anti-Clockwise','nex-forms').'"><i class="fa fa-clock-rotate-left"></i></button>';
...
//LABEL SETTINGS //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
						...
						$output .= '<div id="form-settings-panel" class="form-settings row settings-section active">';
							...
							*/
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';
								$output .= '<div class="settings-header is_top"><span>'.__('Wrapper styling','nex-forms').'</span></div>';
							$output .= '</div>';
							...
							$output .= '<div class="field-setting col-xs-12 s-all">';
								//$output .= '<small>'.__('Form Styling','nex-forms').'</small>';
								$output .= '<div class="input-group input-group-sm">';
									
									
									$output .= '<span class="input-group-addon">';
										$output .= '<span class="icon-text">'.__('Form Background','nex-forms').'</span>';
									$output .= '</span>';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';
								$output .= '<div class="settings-header"><span>'.__('Margins &amp; padding','nex-forms').'</span></div>';
							$output .= '</div>';
						$output .= '<div class="field-setting col-xs-12 s-all">';
							
						//$output .= '<small>'.__('Field wrapper margins and padding','nex-forms').'</small>';
											$output .= '<div class="outer-mp-wrapper">
                                            	<div class="mp-s-label top-label">Top</div>
                                                <div class="mp-s-label right-label">Right</div>
                                                <div class="mp-s-label bottom-label">Bottom</div>
                                                <div class="mp-s-label left-label">Left</div>
                                                <div class="margin-wrapper">
                                                <div class="m-label">Margins</div>
                                                	<div class="m-top"><input type="number" name="form_margin_top" id="form_margin_top" value="0" /></div>
												...
												<div class="b-label">Border Line</div>
												</div>
                                                <div class="padding-wrapper">
                                                <div class="p-label">Padding</div>
                                                    <div class="p-top"><input type="number" name="form_padding_top" id="form_padding_top"  min="0" /></div>
                                                    <div class="p-right"><input type="number" name="form_padding_right" id="form_padding_right"  min="0" /></div>
                                                    <div class="p-bottom"><input type="number" name="form_padding_bottom" id="form_padding_bottom" min="0" /></div>
                                                    <div class="p-left"><input type="number" name="form_padding_left" id="form_padding_left" min="0" /></div>
                                                </div>
                                                <div class="center-wrapper">Form</div>
                                            </div>';
										$output .= '</div>';
							$output .= '<span class="reset-button reset-form-margins">';
								$output .= '<span class="fa fa-refresh" title="Reset to Default"></span> Reset Margins';
							$output .= '</span>';
							
							$output .= '<span class="reset-button reset-form-padding">';
								$output .= '<span class="fa fa-refresh" title="Reset to Default"></span> Reset Padding';
							$output .= '</span>';
						...
						$output .= '<div class="field-setting col-xs-6 s-all">';
							...
							*/
							...
							/*** Background settings ***/
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';
								$output .= '<div class="settings-header"><span>'.__('Wrapper Background Image Settings','nex-forms').'</span></div>';
							$output .= '</div>';
	...
	/*** Text Alignment ***/		$output .= '<span class="input-group-addon ">';
										$output .= '<span class="icon-text">'.__('Font','nex-forms').'</span>';
									$output .= '</span>';
									...
									$output .= '</select>';
									$output .= '<span class="input-group-addon ">';
										$output .= '<span class="icon-text">'.__('Size','nex-forms').'</span>';
									$output .= '</span>';
							...
							$output .= '<nav class="nav-extended settings_tabs_nf">
									<div class="nav-content aa_bg_main">
									  <ul class="tabs_nf tabs_nf-transparent sec-menu aa_menu">
										...
										<li id="extra-settings" class="tab"><a href="#extra-settings-panel">'.__('Field Wrapper','nex-forms').'</a></li>
									  </ul>
									</div>
								 </nav>';
						$output .= '</div>';
...
//LABEL SETTINGS //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
	...
	/*** Label text ***/
								...
								$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';	
									$output .= '<div class="settings-header is_top"><span>'.__('Main Label','nex-forms').'</span></div>';
								$output .= '</div>';
	...
	/*** Input underline ***/
										...
										$output .= '</span>';
		/*** Label text color ***/
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Font Color" data-original-title="Font Color">Font Color</span>';
										...
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Font Size" data-original-title="Font Size">Font Size</span>';
										$output .= '<input type="text" class="form-control" name="set_label_font_size" id="set_label_font_size" value="14"  placeholder="Font Size">';
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Margin Bottom" data-original-title="Margin Bottom">Margin Bottom</span>';
	...
	/*** Sub-label text ***/
								...
								$output .= '<div class="field-setting is-settings-header col-xs-12 s-all none_material">';	
									$output .= '<div class="settings-header"><span>'.__('Sub-Label','nex-forms').'</span></div>';
								$output .= '</div>';
								...
								$output .= '</div>';
								//$output .= '<div class="field-setting col-xs-4 s-all"></div>';
								$output .= '<div class="field-setting col-xs-12 s-all s-odd_setting none_material">';	
									$output .= '<div class="input-group input-group-sm">';
	...
	/*** Label width ***/		
								...
								$output .= '<div class="field-setting is-settings-header col-xs-12 s-all none_material">';	
									$output .= '<div class="settings-header"><span>'.__('Layout','nex-forms').'</span></div>';
								$output .= '</div>';
	...
	/*** Label position ***/
									$output .= '<div role="group" class="btn-group label-position">';
										...
										$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf none" type="button" 	title="'.__('Hidden','nex-forms').'"><i class="fa fa-eye-slash"></i></button>';
									$output .= '</div>';
								$output .= '</div>';
				...
				$output .= '<div class="extra-settings row settings-section">';
						...
						*/
						...
						$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';
								$output .= '<div class="settings-header is_top"><span>'.__('Background &amp; border styling','nex-forms').'</span></div>';
							$output .= '</div>';
						$output .= '<div class="field-setting col-xs-12 s-all"><br />';
								$output .= '<div class="input-group input-group-sm">';
									...
									$output .= '<span class="input-group-addon">';
											$output .= '<span class="icon-text">'.__('Background Color','nex-forms').'</span>';
										$output .= '</span>';
									
									$output .= '<span class="input-group-addon   action-btn color-picker" spellcheck="false"><input type="text" class="form-control fw-bg-color" name="fw-bg-color" id="bs-color"></span>';
								
									$output .= '<span class="input-group-addon">';
											$output .= '<span class="icon-text">'.__('Border Color','nex-forms').'</span>';
										$output .= '</span>';
									
									$output .= '<span class="input-group-addon   action-btn color-picker" spellcheck="false"><input type="text" class="form-control fw-brd-color" name="fw-brd-color" id="bs-color"></span>';
								
									$output .= '<span class="input-group-addon">';
											$output .= '<span class="icon-text">'.__('Border Width','nex-forms').'</span>';
										$output .= '</span>';
									$output .= '<input type="number" name="fw-brd-size" id="fw-brd-size" class="form-control" value="0" min="0">';
									$output .= '<span class="input-group-addon">';
									
									$output .= '<span class="icon-text">'.__('Border Radius','nex-forms').'</span>';
										$output .= '</span>';
									$output .= '<input type="number" name="fw-brd-radius" id="fw-brd-radius" class="form-control" value="0" min="0">';
						...
						//$output .= '<small>'.__('Field wrapper margins and padding','nex-forms').'</small>';
											$output .= '<div class="outer-mp-wrapper">
                                                ...
                                                <div class="margin-wrapper">
                                                <div class="m-label">Margins</div>
                                                	<div class="m-top"><input type="number" name="field_spacing_margin_top" id="field_spacing_margin_top" value="0" /></div>
                                                ...
                                                <div class="padding-wrapper">
                                                <div class="p-label">Padding</div>
                                                    <div class="p-top"><input type="number" name="field_spacing_padding_top" id="field_spacing_padding_top"  value="0" min="0" /></div>
                                                    <div class="p-right"><input type="number" name="field_spacing_padding_right" id="field_spacing_padding_right"  value="0" min="0" /></div>
                                                    <div class="p-bottom"><input type="number" name="field_spacing_padding_bottom" id="field_spacing_padding_bottom" value="0" min="0" /></div>
                                                    <div class="p-left"><input type="number" name="field_spacing_padding_left" id="field_spacing_padding_left" value="0" min="0" /></div>
                                                </div>
                                                <div class="center-wrapper">Field</div>
                                            </div>';
						...
						$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';
								$output .= '<div class="settings-header"><span>'.__('Device Visibility','nex-forms').'</span></div>';
							$output .= '</div>';
						$output .= '<div class="field-setting col-xs-12 s-all">';	
											$output .= '<div role="group" class="btn-group setting-device-only">';
												$output .= '<small>'.__('Show this field only on','nex-forms').'</small>';
...
/*** Input Name ***/
						...
						$output .= '<div class="field-setting col-xs-12 s-thumbs-select-single s-thumbs-select-multi">';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 no-batch-edit s-text s-upload-image s-sigs s-slider s-math s-math-slider s-star-rating s-password s-tags s-spinner s-select s-multi-select s-checks s-radios s-thumbs-select s-thumbs-select-single s-thumbs-select-multi s-super-select">';
								$output .= '<div class="settings-header is_top"><span>'.__('General Settings','nex-forms').'</span></div>';
							$output .= '</div>';
							
							
							$output .= '<div class="field-setting no-batch-edit col-xs-12 s-math s-math-slider">';
										$output .= '<small class="first-setting">'.__('Math Result Input Name','nex-forms').'</small>';
										$output .= '<input type="text" class="form-control" name="set_math_input_name" id="set_math_input_name"  placeholder="Unique Identifier">';
									
								$output .= '</div>';	
							
							$output .= '<div class="field-setting no-batch-edit col-xs-12 s-text s-upload-image s-sigs s-slider s-star-rating s-password s-tags s-spinner s-select s-multi-select s-checks s-radios s-thumbs-select s-thumbs-select-single s-thumbs-select-multi s-super-select">';
								
									$output .= '<small class="first-setting">'.__('Input Name','nex-forms').'</small>';
...
/*** Input ID ***/					
							$output .= '<div class="field-setting no-batch-edit col-xs-6 s-text s-tags s-select s-multi-select s-password none_material">';	
...
/*** Signature Width ***/	
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-sigs">';
								$output .= '<div class="settings-header "><span>'.__('Digital Signature Styling Options','nex-forms').'</span></div>';
							$output .= '</div>';
...
/*** Date Format Placeholder ***/
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-time none_jqui">';
								$output .= '<div class="settings-header is_top"><span>'.__('Time Picker Setup','nex-forms').'</span></div>';
							$output .= '</div>';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-date none_jqui">';
								$output .= '<div class="settings-header is_top"><span>'.__('Date Picker Setup','nex-forms').'</span></div>';
							$output .= '</div>';
...
/*** Date Format Language ***/	
							...
							$output .= '</div>';
							 ...
							 $output .= '<div class="field-setting is-settings-header col-xs-12 s-super-select">';
								$output .= '<div class="settings-header "><span>'.__('Icon Field Settings','nex-forms').'</span></div>';
							$output .= '</div>';
	...
	/*** Input Styling ***/		
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-text s-select s-multi-select s-spinner s-submit s-reset s-tags s-math s-math-slider">';
								$output .= '<div class="settings-header"><span>'.__('Default value &amp; Input Styling','nex-forms').'</span></div>';
							$output .= '</div>';
							
							$output .= '<div class="field-setting no-batch-edit col-xs-12 s-text s-select s-multi-select s-spinner s-submit s-reset s-headings s-tags s-math s-math-slider">';	
								$output .= '<small>'.__('Default value','nex-forms').'</small>';
							...
							$output .= '<div class="field-setting col-xs-12 s-text s-select s-multi-select s-spinner s-submit s-reset s-headings s-paragraph s-html s-tags s-math s-math-slider s-odd_setting odd_setting_input_val">';	
									
									$output .= '<input type="text" class="form-control field-setting s-text s-reset" name="set_input_val" placeholder="Set default value" id="set_input_val">';
										$output .= '<input type="text" class="form-control field-setting s-select s-multi-select" name="set_default_select_value" placeholder="Set default option" id="set_default_select_value">';
								...
								$output .= '</div>';
								//$output .= '<div class="field-setting col-xs-4 s-all"></div>';
								$output .= '<div class="field-setting col-xs-12 s-text s-select s-multi-select s-spinner s-submit s-reset s-headings s-paragraph s-html s-tags s-math s-math-slider s-odd_setting">';										
									$output .= '<div class="input-group input-group-sm">';
	...
	/*** Input underline ***/
										...
										$output .= '</span>';
	/*** Input text color ***/
										$output .= '<span class="input-group-addon group-addon-label input-text-color" data-toggle="tooltip_bs" title="Font Size">Font Size</span>';
	...
	/*** Input alignment ***/
								...
								/*$output .= '<div class="field-setting col-xs-3 s-text s-spinner s-select s-multi-select none_material">';	
	...
	/*** Input size ***/
								...
								/*$output .= '<div class="field-setting col-xs-4 s-text s-select s-multi-select s-spinner">';	
								$output .= '<div role="group" class="btn-group align-input-container">';
									$output .= '<small>Alignment</small>';
									$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf left" type="button" title="Left"><i class="fa fa-align-left"></i></button>';
									$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf center" type="button" title="Center"><i class="fa fa-align-center"></i></button>';
							...
							$output .= '</div>';*/
								...
								$output .= '<div class="field-setting col-xs-3 s-text s-tags  s-spinner s-select s-multi-select none_material">';
								...
								$output .= '<div class="field-setting is-settings-header col-xs-12 s-spinner">';
								$output .= '<div class="settings-header "><span>'.__('Spinner Setup','nex-forms').'</span></div>';
							$output .= '</div>';
	...
	/*** Button Options ***/
			...
			/*** Button size ***/
								$output .= '<div class="field-setting col-xs-4 s-submit s-reset">';	
			...
			/*** heading alignment ***/		
						...
						*/
						...
						/*$output .= '<div class="field-setting is-settings-header col-xs-12 s-all">';
								$output .= '<div class="settings-header"><span>'.__('Margins &amp; padding','nex-forms').'</span></div>';
							$output .= '</div>';*/
						$output .= '<div class="field-setting col-xs-12 s-paragraph s-headings s-html s-divider s-icon s-math s-math-slider">';
						...
						//$output .= '<small>'.__('Field wrapper margins and padding','nex-forms').'</small>';
											$output .= '<div class="outer-mp-wrapper">
                                                ...
                                                <div class="margin-wrapper">
                                                <div class="m-label">Margins</div>
                                                	<div class="m-top"><input type="number" name="html_field_spacing_margin_top" id="html_field_spacing_margin_top" value="0" /></div>
                                                ...
                                                <div class="padding-wrapper">
                                                <div class="p-label">Padding</div>
                                                    <div class="p-top"><input type="number" name="html_field_spacing_padding_top" id="html_field_spacing_padding_top"  min="0" /></div>
                                                    <div class="p-right"><input type="number" name="html_field_spacing_padding_right" id="html_field_spacing_padding_right"  min="0" /></div>
                                                    <div class="p-bottom"><input type="number" name="html_field_spacing_padding_bottom" id="html_field_spacing_padding_bottom" min="0" /></div>
                                                    <div class="p-left"><input type="number" name="html_field_spacing_padding_left" id="html_field_spacing_padding_left" min="0" /></div>
                                                </div>
                                                <div class="center-wrapper">HTML Element</div>
                                            </div>';
										$output .= '</div>';
					...
					$output .= '<div class="field-setting is-settings-header col-xs-12 s-paragraph s-headings s-html s-divider s-icon s-math s-math-slider">';
						...
						$output .= '<div class="field-setting col-xs-12 s-paragraph s-headings s-html s-divider s-icon s-math s-math-slider">';	
											$output .= '<div role="group" class="btn-group setting-device-only">';
												$output .= '<small>'.__('Show only on','nex-forms').'</small>';
												//$output .= '<small><em>'.__('The grid will hold its inline layout up to the device selected','nex-forms').'</em></small>';
												$output .= '<button class="btn btn-default active waves-effect-nf waves-light-nf set-mobile" data-val="nf-no-mobile" type="button" title="'.__('Mobiles','nex-forms').'"><i class="fa fa-mobile"></i></button>';
												$output .= '<button class="btn btn-default active waves-effect-nf waves-light-nf set-tablet" data-val="nf-no-tablet" type="button" title="'.__('Tablets','nex-forms').'"><i class="fa fa-tablet"></i></button>';
												$output .= '<button class="btn btn-default active waves-effect-nf waves-light-nf set-laptops" data-val="nf-no-laptop" type="button" title="'.__('Laptops','nex-forms').'"><i class="fa fa-laptop"></i></button>';
	...
	/*** Select options ***/	
							...
							$output .= '<div class="field-setting is-settings-header no-batch-edit col-xs-12 s-select s-multi-select s-radios s-checks s-thumbs-select-single s-thumbs-select">';
								$output .= '<div class="settings-header "><span>'.__('Selection Setup','nex-forms').'</span></div>';
							$output .= '</div>';
							
							$output .= '<div class="field-setting no-batch-edit col-xs-6 s-select">';
								$output .= '<div role="group" class="btn-group select-search" >';
									$output .= '<small>'.__('Enable Option Search','nex-forms').'</small>';
									$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf select-search-yes" type="button" title="'.__('Adds a search for the select options','nex-forms').'"><i class="fas fa-check"></i></button>';
									$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf select-search-no" type="button" title="'.__('Disbales select option search','nex-forms').'"><i class="fa fa-close"></i></button>';
								$output .= '</div>';
							$output .= '</div>';
							...
							$output .= '<div class="field-setting no-batch-edit col-xs-12 s-select s-multi-select">';
	...
	/*** Autocomplete options ***/		
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 no-batch-edit s-autocomplete">';
								$output .= '<div class="settings-header "><span>'.__('Autocomplete Setup','nex-forms').'</span></div>';
							$output .= '</div>';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-text s-select s-multi-select s-tags">';
								$output .= '<div class="settings-header"><span>'.__('Icon Settings','nex-forms').'</span></div>';
							$output .= '</div>';
							
							$output .= '<div class="field-setting col-xs-12 s-text s-select s-multi-select s-tags">';
	/*** Input PRE Add-on ***/
	...
	/*** Input POST Add-on ***/
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-thumbs-select">';	
								$output .= '<div class="settings-header"><span>'.__('Thumb Label Styling','nex-forms').'</span></div>';
							$output .= '</div>';
	...
	/*** Input underline ***/
		...
		/*** Label text color ***/
						...
						$output .= '<div class="field-setting col-xs-6 s-thumbs-select">';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-radios s-checks">';	
								$output .= '<div class="settings-header"><span>'.__('Styling','nex-forms').'</span></div>';
							$output .= '</div>';
							$output .= '<div class="field-setting col-xs-12 s-radios s-checks s-thumbs-select-single s-thumbs-select-multi none_material">';
									$output .= '<small class="">'.__('Selectors','nex-forms').'</small>';
									$output .= '<div role="group" class="input-group input-group-sm none_material">';
										
										$output .= '<span class="input-group-addon current_radio_icon"><i class="">Select Icon</i></span>';
										$output .= '<input type="text" class="form-control" name="set_radio_icon" id="set_radio_icon"  placeholder="or enter icon class">';
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Background Color (Unchecked)">BG (Uncheck)</span><span class="input-group-addon  action-btn color-picker" spellcheck="false"><input type="text" class="form-control set-radio-bgc-color-uc" name="set-radio-bgc-color-uc" id="bs-color"></span>';
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Background Color (Checked)">BG (Check)</span><span class="input-group-addon  action-btn color-picker" spellcheck="false"><input type="text" class="form-control set-radio-bgc-color" name="set-radio-bgc-color" id="bs-color"></span>';
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Icon Color">Icon</span><span class="input-group-addon  action-btn color-picker" spellcheck="false"><input type="text" class="form-control set-radio-text-color" name="set-radio-text-color" id="bs-color"></span>';
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Border Color">Border</span><span class="input-group-addon  action-btn color-picker" spellcheck="false"><input type="text" class="form-control set-radio-border-color" name="set-radio-border-color" id="bs-color"></span>';
									$output .= '</div>';
							$output .= '</div>';
							
							
							$output .= '<div class="field-setting col-xs-12 s-radios s-checks s-thumbs-select-single s-thumbs-select-multi none_material">';
									$output .= '<small class="">'.__('Labels','nex-forms').'</small>';
									$output .= '<div role="group" class="input-group input-group-sm none_material">';
										
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Font Color" data-original-title="Font Color">Label Font Size</span>';
										$output .= '<input type="number" class="form-control" name="set_radio_label_size" id="set_radio_label_size" value="13">';
										$output .= '<span class="input-group-addon group-addon-label" data-toggle="tooltip_bs" title="Label Colors">Label Color</span><span class="input-group-addon  action-btn color-picker" spellcheck="false"><input type="text" class="form-control set-radio-label-color" name="set-radio-label-color" id="bs-color"></span>';
									$output .= '</div>';
							$output .= '</div>';
							
							
							$output .= '<div class="field-setting col-xs-3 s-radios s-checks none_material">';
									$output .= '<div role="group" class="btn-group radio-check-size ">';
										$output .= '<small>'.__('Size','nex-forms').'</small>';
										$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf small" type="button" title="'.__('Small','nex-forms').'"><i class="fa fa-font" style="font-size:10px"></i></button>';
										$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf normal" type="button" title="'.__('Normal','nex-forms').'"><i class="fa fa-font" style="font-size:13px"></i></button>';
										$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf large" type="button" title="'.__('Large','nex-forms').'"><i class="fa fa-font" style="font-size:16px"></i></button>';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-slider">';
								$output .= '<div class="settings-header "><span>'.__('Slider setup &amp Styling','nex-forms').'</span></div>';
							$output .= '</div>';
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-text s-tags s-select s-multi-select s-spinner s-date s-time s-password s-panel none_material">';
								$output .= '<div class="settings-header"><span>'.__('Background Settings','nex-forms').'</span></div>';
							$output .= '</div>';
	/*** Background settings ***/	
								$output .= '<div class="field-setting col-xs-12 s-text s-tags s-select s-multi-select s-spinner s-date s-time s-password s-panel none_material">';	
									$output .= '<div role="toolbar" class="btn-toolbar bg-settings">';
	/*** Background image ***/									
										$output .= '<div role="group" class="btn-group align-label">';
											$output .= '<small>'.__('Image','nex-forms').'</small>';
	...
	/**** STAR RATING SETTINGS ****/
							...
							$output .= '<div class="field-setting is-settings-header col-xs-12 s-star-rating">';
								$output .= '<div class="settings-header is_top"><span>'.__('Settings & styling options','nex-forms').'</span></div>';
							$output .= '</div>';
...
/*** Input PRE Add-on ***/
		...
		/**** SLIDER SETTINGS ****/
			...
			/**** GRID SETTINGS ****/
										...
										$output .= '<div class="field-setting is-settings-header col-xs-12 s-grid">';	
											$output .= '<div class="settings-header"><span>'.__('Grid Responsiveness','nex-forms').'</span></div>';
										$output .= '</div>';
										...
										$output .= '<div class="field-setting is-settings-header col-xs-12 s-grid">';	
											$output .= '<div class="settings-header"><span>'.__('Grid Replication Setup','nex-forms').'</span></div>';
										$output .= '</div>';
...
//MATH SETTINGS //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
	...
	/*** Input ID ***/			
								...
								$output .= '<div class="field-setting no-batch-edit col-xs-12 s-headings s-math s-math-slider s-paragraph s-html">';
									$output .= '<small>'.__('Math Equation','nex-forms').'</small>';
									$output .= '<select class="form-control" name="math_fields"></select>';
									$output .= '<textarea class="form-control" name="set_math_logic_equation" id="set_math_logic_equation"></textarea>';
								$output .= '</div>';
...
//ANIMATION SETTINGS //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
	...
	/*** Animation Selection ***/	
		...
		public function print_form_canvas(){
			...
			$set_theme 			= ($theme_settings['0']['theme_name']) 	? $theme_settings['0']['theme_name'] 	: 'default';
			$set_theme_shade 	= (($theme_settings['0']['theme_shade']) ? $theme_settings['0']['theme_shade'] 	: (($user_config['enable-color-adapt']=='3') ? 'dark' : 'light'));
					...
					$output .= '<div class="tool-section select-other-fields other-form-elements" id="toolbar-fields">';
							...
							$droppables = array(
								...
								*/
								...
								'Query' => array
									...
									'field_name' => 'query',
									'required' => 'required',
									'settings_class' => '.s-text, .s-texarea, .s-v-textarea',
									'settings_tabs' => '#label-settings, #input-settings, #validation-settings, #animation-settings, #extra-settings',
									),
								...
								'multi-select' => array
									...
									'icon'	=>	'fas fa-tasks',
									'type' => 'multi-select',
									'settings_class' => '.s-multi-select, .s-v-multi-selections',
									'settings_tabs' => '#label-settings, #input-settings, #validation-settings, #animation-settings, #extra-settings',
									),
								...
								'slider' => array
									...
									'tooltip'	=>	__('Range Slider','nex-forms'),
									'sub_label'	=>	'',
								...
								'touch_spinner' => array
									...
									'sub_label'	=>	'',
									'tooltip'	=>	__('Number Spinner','nex-forms'),
								...
								'digital-signature' => array
									...
									'tooltip'	=>	__('Digital / E-Signature','nex-forms'),
									'sub_label'	=>	'',
						...
						//UPLOADER FIELDS
								...
								'tool-spacer-8' => array
									(
									'type' => 'tool-spacer-start',
									'section' => __('Buttons','nex-forms'),
									'class' => 'form-editor button-fields',
									),
								...
								'prev-button' => array
									(
									'category'	=>	'submit-button button_fields common_fields preset_fields special_fields selection_fields',
									'label'	=>	__('Step Back','nex-forms'),
									'tooltip'	=>	__('Step Back (multi-steps only)','nex-forms'),
									'sub_label'	=>	'',
								...
								'next-button' => array
									(
									'category'	=>	'submit-button button_fields common_fields preset_fields special_fields selection_fields',
									'label'	=>	__('Step Forward','nex-forms'),
									'tooltip'	=>	__('Step Forward (multi-steps only)','nex-forms'),
									'sub_label'	=>	'',
								...
								'reset-button' => array
									(
									'category'	=>	'submit-button button_fields common_fields preset_fields special_fields selection_fields',
									'label'	=>	__('Reset','nex-forms'),
									'tooltip'	=>	__('Reset (Clear Form)','nex-forms'),
									'sub_label'	=>	'',
									'icon'	=>	'fa-solid fa-arrow-rotate-right',
									'type' => 'reset-button',
									'settings_class' => '.s-reset',
									'settings_tabs' => '#input-settings, #animation-settings, #extra-settings',
									),
								
								'tool-spacer-end-8' => array
									(
									'type' => 'tool-spacer-end',
									),
										...
										$output .= '<div id="form_object" class="form_object" style="display:none;">';
											$output .= '<div class="row">';
												$output .= '<div class="col-sm-12" id="field_container">';
													$output .= '<div class="row">';
														if($attr['type']!='submit-button' && $attr['type']!='submit-button2' && $attr['type']!='reset-button' && $attr['type']!='next-button' && $attr['type']!='prev-button')
															{
															if($label_pos != 'right')
																{
																...
																switch($attr['type'])
																					...
																					$output .= '<div class="input-inner">';
																						...
																						$output .= '<div class="image-choices-choice col-sm-4">
																									  <label class="radio-inline" for="thumb_select_thumb_1" >
																										  ...
																										  <div class="prettyradio"><input name="thumb_select" type="radio" value="1" id=""  style="display: none;" autocomplete="disabled" class="the_input_element"><a class="ui-state-default" style="background: #2979ff;"></a></div>
																						...
																						$output .= '<div class="image-choices-choice col-sm-4">
																									  <label class="radio-inline" for="thumb_select_thumb_1">
																										  <div class="thumb-image-outer-wrap">
																										  <div class="prettyradio"><input name="thumb_select" type="radio" value="2" id="" style="display: none;" autocomplete="disabled" class="the_input_element"><a class="ui-state-default" style="background: #2979ff;"></a></div>
																						...
																						$output .= '<div class="image-choices-choice col-sm-4">
																								  <label class="radio-inline" for="thumb_select_thumb_1">
																									  <div class="thumb-image-outer-wrap">
																									  <div class="prettyradio"><input name="thumb_select" type="radio" value="3" id="" style="display: none;" autocomplete="disabled" class="the_input_element"><a class="ui-state-default" style="background: #2979ff;"></a></div>
																				...
																				$output .= '<div class="the-icon-field-container the_input_element">';
																					...
																					$output .= '<div class="selected-icon-holder" style="display:none;">
																										...
																										<div class="icon-holder default-selected-icon is_default_selection icon_holder_0" data-icon-number="0">
																										  <input class="the_input_element" type="radio" name="icon_select" value="0">
																				...
																				$output .= '<div class="the-icon-option-container">';	
																					$output .= '<div class="icon-container col-sm-12">
																									<div class="icon-holder icon_holder_1" data-icon-number="1">
																									  <input class="the_input_element" type="radio" name="icon_select" value="1">
																									  <div class="icon-select">
																								  ...
																								  <div class="icon-holder icon_holder_2" data-icon-number="2">
																									  <input class="the_input_element" type="radio" name="icon_select" value="2">
																									  <div class="icon-select">
																	...
																	/*case 'nf-color-picker':
																		$output .= '<div class="'.$input_width.'  input_container">';
																				$output .= '<input list="presetColors" type="color" name="'.$nf_functions->format_name($attr['label']).'" class="form-control error_message the_input_element '.$preferences['field_preferences']['pref_input_size'].' '.$preferences['field_preferences']['pref_input_text_align'].'" data-maxlength-color="label label-success" data-maxlength-position="bottom" data-maxlength-show="false" data-default-value=""  data-onfocus-color="#66AFE9" data-drop-focus-swadow="1" data-placement="bottom" data-content="'.$preferences['validation_preferences']['pref_requered_msg'].'" data-secondary-message="" title="">';
																				$output .= '<datalist id="presetColors">
  <option value="#ff0000"/>
  <option value="#00ff00"/>
  <option value="#0000ff"/>
</datalist>';
																	...
																	case 'next-button':
																		$output .= '<div class="col-sm-12  input_container">';
																			$output .= '<button class="svg_ready the_input_element btn btn-default nex-step ui-state-default">Next</button>';
																		$output .= '</div>';
																		$i=0;
																	break;
																	...
																	case 'prev-button':
																		$output .= '<div class="col-sm-12  input_container">';
																			$output .= '<button class="svg_ready the_input_element btn btn-default prev-step ui-state-default">Back</button>';
																		$output .= '</div>';
																		$i=0;
																	break;
																	...
																	case 'reset-button':
																		$output .= '<div class="col-sm-12  input_container">';
																			$output .= '<input type="reset" class="form-control svg_ready the_input_element btn btn-default ui-state-default" value="Reset">';
																		$output .= '</div>';
																		$i=0;
																	break;
														...
														if($attr['type']!='submit-button' && $attr['type']!='submit-button2' && $attr['type']!='next-button' && $attr['type']!='reset-button' && $attr['type']!='prev-button')
															{
															if($label_pos == 'right')
																{
																$output .= '<div class="'.$label_width.' '.$align_class.' label_container '.(($preferences['field_preferences']['pref_label_text_align']) ? $preferences['field_preferences']['pref_label_text_align'] : 'align_left').'" '.$hide_label.'>';
						...
						//HEADING
							...
							$output .= '<div class="tool-spacer form-editor"><span class="tool-section-title" title="'.__('Math','nex-forms').'" data-toggle="" data-placement="top">'.__('Math','nex-forms').'</span>';
								...
								$output .= '<div class="field form_field all_fields math_logic math_logic_slider math_fields " data-settings=".s-math-slider" data-settings-tabs="#input-settings, #animation-settings, #math-settings" >';
									...
									$output .= '<div class="draggable_object "   >';
										$output .= '<i title="Math Logic Slider" data-toggle="tooltip_bs" data-placement="bottom" class="fa-solid fa-code-commit"></i>';
									$output .= '</div>';
				...
				$output .= '<div class="width_bar" style="display:none;">';
					$output .= '<div class="width_input" style="display:none;">';
						...
						$output .= '<span class="input-group-addon selection">';
									$output .= '<span class="icon-text"><span class="icon-text-label">Theme</span> <span class="dashicons-before dashicons-admin-appearance"></span></span>';
								$output .= '</span>';
						$output .= '<select name="set_form_theme" class="form-control set_form_theme '.$get_theme.'" data-selected="'.$set_form_theme.'" data-toggle="tooltip_bs2" data-placement="bottom" title="Select Overall Form Theme">
									<option value="bootstrap">'.__('Bootstrap','nex-forms').'</option>
						...
						$output .= '<div class="input-group settings_form_padding"  >';	
							...
							$output .= '<input type="number" name="form_padding" id="form_padding" data-toggle="tooltip_bs2" data-placement="bottom" title="Form Overall Padding" class="form-control" value="0">';
						$output .= '</div>'; 
							
						$output .= '<div class="settings_more_styling_options" >';
							$output .= '<small class="label">&nbsp;</small>';
							$output .= '<div class="btn" data-toggle="tooltip_bs2" data-placement="bottom" title="More Styling Options"><span class="fas fa-palette" ></span> </div>';
						$output .= '</div>'; 	
	...
	$output .= '</div>';
			...
			$output .= '</div>';
				...
				$output .= '<div class="material_box settings-column-style  conditional_logic_wrapper conditional_logic simple_view">';
					...
					$output .= '</div>
					<div id="close-settings" class="close-area hidden">
						<span class="fa fa-close"></span>
					</div>
					';
...
12. Create your action<br /></div>');
	...
	public function print_embed_setup(){
			...
			$output .= '<div class="form_attr_wrapper">';
