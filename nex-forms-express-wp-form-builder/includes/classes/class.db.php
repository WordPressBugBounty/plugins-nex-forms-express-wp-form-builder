...
/* INSERT */
		...
		public function checkout()
			...
			$api_params = array( 'check_key' => 1,'version' => '9.1.4','ins_data'=>get_option('7103891'));
...
';
	...
	function deactivate_license(){
		...
		if($theme->Name!='NEX-Forms Demo')
			...
			$api_params = array( 'client_deactivate_license' => 1,'version' => '9.1.4','key'=>get_option('7103891'));
			$response = wp_remote_post( 'https://basixonline.net/activate-license-new-api-v3', array('timeout'   => 10,'sslverify' => false,'body'  => $api_params) );
			update_option( 'nf_activated', false );
			update_option( 'nf_fs_activated', false );
			}
...
You are using '.$email_config['email_method'].' as your emailing method';
			...
			//Set the hostname of the mail server
				...
				if (!$mail->send()) {
				    NEXForms_clean_echo( "Mailer Error: " . $mail->ErrorInfo);
				} else {
				   NEXForms_clean_echo( "Message sent!");
					//echo print_r($mail);
				}
			}
...
class NEXForms_widget extends WP_Widget{
	...
	function widget($args, $instance){
		NEXForms_clean_echo( '<div class="widget">');
		NEXForms_ui_output(
			array(
				'id'=>$instance['form_id'],
...
.btn-blue-gray { background: #607d8b; }
		*/
		...
		NEXForms_clean_echo( NEXForms_widget_controls::parse($tpl, $placeholders));
	}
