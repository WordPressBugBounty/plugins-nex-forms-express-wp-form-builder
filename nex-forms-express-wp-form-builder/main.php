...
add_option('NFISENVA',false);
if(get_option('nf_activated'))
	update_option('NFISENVA',false);  
...
if ( ! function_exists( 'nf_fs' ) ) {
    function nf_fs() {
        ...
        if ( ! isset( $nf_fs ) ) {
			...
			$is_en =  (get_option( 'nf_activated')) ? false : true;
			$is_fs =  (get_option( 'nf_fs_activated')) ? true : false;
			
            $nf_fs = fs_dynamic_init( array(
                'id'                  => '18837',
                'slug'                => 'nex-forms',
                'type'                => 'plugin',
                'public_key'          => 'pk_71b5d26c72d0e13fd0b1d533f0fbc',
                'is_premium'          => true,
               ...
               'menu'                => array(
                    'slug'           => ($is_fs) ? 'nex-forms-dashboard' : '',
					'has_submenu' 	 => false,
                    'contact'        => false,
                    'support'        => false,
                ),
    ...
    nf_fs();
    do_action( 'nf_fs_loaded' );
}

function enqueue_nf_admin_public_styles($hook){
	if(is_admin())
			wp_enqueue_style('nex-forms-public-admin', plugins_url( '/admin/css/'.NF_PATH.'public.css',__FILE__),'','9.2.2');
}
...
class NEXForms5_Config{
	...
	public $nex_forms_add_ons = array
			(
			'title'					=>	'text',
			'description'			=>	'text',
			'price'					=>	'text',
...
function NEXForms5_main_menu(){
	...
	if(get_option('NFISENVA'))
		...
		if ($supported_date < $now)	
			{
			add_submenu_page( 'nex-forms-dashboard', 'NF-Add-ons','Add-ons', NF_USER_LEVEL, 'nex-forms-page-add-ons', 'NEXForms_get_add_ons');		
			}
		else
			{
	...
	add_submenu_page( '', 'NF-Builder-View','Builder', NF_USER_LEVEL, 'nex-forms-builder', 'NEXForms_form_builder');
	add_submenu_page( '', 'NF-Test','Test', NF_USER_LEVEL, 'nex-forms-test-page', 'NEXForms_test_page');
	
	add_submenu_page( '', 'NF-Welcome','Welcome', NF_USER_LEVEL, 'nf-welcome-page', 'NEXForms_welcome_page_content');
...
function NEXForms_my_menu_pages() {
    ...
    $hook = add_submenu_page( '', 'Page Title', 'Page Title', NF_USER_LEVEL, 'nex-forms-preview', function() { });
	...
	$p_type = isset($_REQUEST['p-type']) ? sanitize_text_field($_REQUEST['p-type']) : 'full';
	$p_device = isset($_REQUEST['p-device']) ? sanitize_text_field($_REQUEST['p-device']) : 'desktop';
	
	if($p_type=='full' && $p_device=='desktop')	
		NEXForms_clean_echo(  '<div class="preview_container" style="padding:40px 20%">');	
	else
		NEXForms_clean_echo(  '<div class="preview_container" style="padding:0px">');	
/* UI STYLE REGISTRATION */	

	
	if($styles_config['incstyle-font-awesome']=='1' || !array_key_exists('incstyle-font-awesome',$styles_config))
		{
		wp_enqueue_style('nex-forms-font-awesome-6',plugins_url( '/public/css/fa6/css/all.min.css',__FILE__),'',$css_js_version);
		wp_enqueue_style('nex-forms-font-awesome-4-shims',plugins_url( '/public/css/fa6/css/v4-shims.min.css',__FILE__),'',$css_js_version);
		wp_enqueue_style('nex-forms-font-awesome-5-shims',plugins_url( '/public/css/fa6/css/v5-font-face.min.css',__FILE__),'',$css_js_version);
		}
	...
	if($styles_config['incstyle-bootstrap']=='1' || !array_key_exists('incstyle-bootstrap',$styles_config))
		wp_enqueue_style('nex-forms-bootstrap-ui', plugins_url( '/public/css/min/ui-bootstrap.css',__FILE__),'',$css_js_version, true);
		
	wp_enqueue_style('nex-forms-ui', plugins_url( '/public/css/'.NF_PATH.'ui.css?v=7.2.7',__FILE__),'',$css_js_version, true);
		
	if($styles_config['incstyle-animations']=='1' || !array_key_exists('incstyle-animations',$styles_config))
		wp_enqueue_style('nex-forms-animations', plugins_url( '/public/css/min/animate.css',__FILE__),'',$css_js_version, true);		

	wp_enqueue_style('nex-forms-material-theme-amber', plugins_url( '/public/css/themes/amber.css',__FILE__),'',$css_js_version, true);
	wp_enqueue_style('nex-forms-materialize', plugins_url( '/public/css/min/materialize-ui.css',__FILE__),'',$css_js_version, true);
	wp_enqueue_style('nex-forms-preview', plugins_url( '/admin/css/preview.css',__FILE__),'',$css_js_version, true);	
	
	wp_enqueue_style('nex-forms-selects-css', plugins_url( '/public/css/min/nex-select.css',__FILE__),'',$css_js_version, true);
		
/* UI SCRIPT REGISTRATION */
	if($script_config['inc-bootstrap']=='1' || !$script_config['inc-bootstrap'])
		wp_enqueue_script('nex-forms-bootstrap.min',  plugins_url( '/public/js/min/bootstrap.min.js',__FILE__),'',$css_js_version, true);
	if($script_config['inc-wow']=='1' || !$script_config['inc-wow'])
		wp_enqueue_script('nex-forms-wow',  plugins_url( '/libs/wow.min.js',__FILE__),'',$css_js_version, true);
	if($script_config['inc-raty']=='1' || !$script_config['inc-raty'])
		wp_enqueue_script('nex-forms-raty-fa',  plugins_url( '/public/js/min/jquery.raty-fa.js',__FILE__),'',$css_js_version, true);
	
	wp_enqueue_script('nex-forms-input-mask', plugins_url( '/public/js/min/jquery.inputmask.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-sigs', plugins_url( '/public/js/min/jquery.sig.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-tags', plugins_url( '/public/js/min/jquery.tags.js',__FILE__),'',$css_js_version, true);
	
	wp_enqueue_script('nex-forms-timer',  plugins_url( '/public/js/min/jquery.timer.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-materialize.min',  plugins_url( '/libs/materialize.min.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-onload', plugins_url( '/public/js/'.NF_PATH.'nexf-onload-ui.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-math.min',  plugins_url( '/libs/math.min.js',__FILE__),'',$css_js_version, true);
	
	wp_enqueue_script('nex-forms-moment.min', plugins_url( '/libs/moment.min.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-locales.min', plugins_url( '/libs/locales.min.js',__FILE__),'',$css_js_version, true);
	wp_enqueue_script('nex-forms-bootstrap-datetimepicker', plugins_url( '/public/js/'.NF_PATH.'bootstrap-datetimepicker.js',__FILE__),'',$css_js_version, true);
	
	wp_enqueue_script('nex-forms-bootstrap-touchspin', plugins_url( '/public/js/min/jquery.bootstrap-touchspin.js',__FILE__),'',$css_js_version, true);
	
	wp_enqueue_script('nex-forms-selects-js', plugins_url( '/libs/nex-select.js',__FILE__),'',$css_js_version, true);
	
	
	wp_enqueue_script('jquery-ui-slider');
	
	//wp_enqueue_script('nex-forms-jquery-ui',  plugins_url( '/public/js/min/jquery-ui.js',__FILE__),'',$css_js_version, true);
	...
	if($form_attr->form_theme=='m_design' || $form_attr->form_theme=='neumorphism')
		wp_enqueue_style('nex-forms-material-theme-'.$set_theme, plugins_url( '/public/css/themes/'.$set_theme.'.css',__FILE__),'',$css_js_version, true);
...
function NEXForms_test_page(){
	...
	echo '<a href="#" class="fs-toggle-whitelabel-mode">Click here</a>';
	
    nf_fs()->_account_page_render();
...
function NEXForms5_run_instalation(){
	...
	$instalation = new NF5_Instalation();
	$instalation->component_prefix 		=  $config->plugin_prefix;
	$instalation->component_alias		=  'nex_forms_add_ons';
	$instalation->db_table_fields		=  $config->nex_forms_add_ons;
	$instalation->db_table_primary_key	=  $config->plugin_db_primary_key;
	$instalation->install_component_table();	
...
function NEXForms_form_preview(){
	...
	if($theme_settings['0']['theme_shade']=='dark')
		NEXForms_clean_echo( '<style type="text/css">html, body, #wpcontent, #wpwrap, #wpbody-content  {background: #444 !important;}</style>');
	NEXForms_clean_echo( NEXForms_ui_output(sanitize_text_field($_REQUEST['form_Id']),'',''));
}
...
function NEXForms_ui_output( $atts , $echo='',$prefill_array='',$unigue_form_Id=''){
	...
	if($atts==0)
		...
		wp_enqueue_style('nex-forms-font-awesome-6');
		wp_enqueue_style('nex-forms-font-awesome-5-shims');
	...
	if(is_array($atts))
		...
		$id						= (int) esc_html(sanitize_text_field($atts['id']));
		...
		{
		$id						= (int) esc_html(sanitize_text_field($atts));
		$open_trigger 			= '';
		$auto_popup_delay 		= '';
		$auto_popup_scroll_top 	= '';
		$exit_intent 			= '';
	...
	if(isset($set_array['is_inc_pro_select']))
		{
		if($set_array['is_inc_pro_select']=='true')
			$inc_pro_select = true;
		else
			$inc_pro_select = false;
		}
	...
	if($open_trigger=="popup")
			...
			$popup_scripts .= '
				...
				addEvent(document, \'mouseout\', function(evt) {
					if (evt.toElement == null && evt.relatedTarget == null && exit_popup==0) {
						//run_parent_css_reset('.$id.');
					   jQuery(\'#nexForms_popup_'.$id.'\').modal_nf(\'open\');
						exit_popup = 1;
						...
						for (var key in get_nex_forms) {
							...
							if(get_nex_forms[key] == false)
								...
								var data = 	
									...
									nex_forms_id		: jQuery(\'form#\'+'.$id.').find(\'input[name="nex_forms_Id"]\').val()
									};
								jQuery.post(ajaxurl, data, function(response){});
								get_nex_forms['.$id.'] = true;
						...
						function()
							...
							jQuery(document).on(\'click\', ".'.esc_html($element_class).'",
								function(e)
									...
									e.preventDefault();
									run_parent_css_reset('.$id.');
									jQuery(\'#nexForms_popup_'.$id.$element_class.'\').modal_nf(\'open\');
									}
								);
							}
						);
			...
			$output .= '<div class="pre_fill_fields">';
				if(is_array($prefill_array))
					...
					foreach($prefill_array as $key => $val)
						{	
						if(get_option('nf_activated') || get_option('nf_fs_activated'))				
						$output .= '<input type="hidden" name="'.esc_attr(sanitize_key($key)).'"  data-original-value="'.str_replace('\\','',sanitize_text_field($val)).'" value="'.str_replace('\\','',sanitize_text_field($val)).'">';	
						}	
					}
		...
		//OPEN POPUP MODAL
				$output .= '<div  
				data-backdrop="'.esc_attr($backdrop).'" 
				data-open-animation="'.esc_attr($open_animation).'" 
				data-close-animation="'.esc_attr($close_animation).'" 
				data-overlay-opacity="'.esc_attr($overlay_opacity).'" 
				class="modal '.((!get_option('nf_activated') && !get_option('nf_fs_activated')) ? 'do_nf_popup' : '' ).' fade nex_forms_modal animated '.(($background=='transparent') ? 'no_shadow' : '').' '.esc_attr($open_animation).' v_'.esc_attr($v_position).' h_'.esc_attr($h_position).'" 
				style="'.(($background=='use-form-background') ? $form_css_style : 'background:'.$background).';padding-left:'.esc_attr($padding_left).' !important; padding-right:'.esc_attr($padding_right).' !important; padding-top:'.esc_attr($padding_top).' !important; padding-bottom:'.esc_attr($padding_bottom).' !important;'.' width:'.esc_attr($width).';height:'.esc_attr($height).' !important; margin: '.esc_attr($v_margin).' '.esc_attr($h_margin).'; " id="nexForms_popup_'.esc_attr($id).esc_attr($element_class).'" tabindex="-1" role="dialog">';
		...
		$output .= '<div id="nex-forms" data-loader="'.$loader_type.'" data-msg-hide-form="'.$msg_hide_form.'" data-msg-position="'.$msg_position.'" data-msg-placement="'.$msg_placement.'"  class="nex-forms '.$nf_functions->format_name($form_attr->title).' '.(($make_sticky=='yes' && (!get_option('nf_activated') && !get_option('nf_fs_activated'))) ? 'do_nf_sticky' : '' ).' '.(($make_sticky=='yes') ? 'is-nf-sticky-form' : '').'">';
			...
			$output .= '<div class="set_form_theme theme-'.$set_theme.'">';
				...
				$output .= '<div data-timer-start="'.$timer_start.'" data-timer-end="'.$timer_end.'" class="inner-canvas-container ui-nex-forms-container ui-nex-forms-container-fe '.(($add_timer=='yes') ? 'has_time_limit timer_'.$timer_type : '' ).' '.(($form_attr->form_theme) ? $form_attr->form_theme : 'bootstrap').'" id="ui-nex-forms-container-'.$form_attr->Id.'"  >';
					...
					if(!get_option('nf_activated') && !get_option('nf_fs_activated')){ $post_action = admin_url('admin-ajax.php');$post_method = 'post';}
					...
					if($is_paypal=='yes' && function_exists('nf_not_found_notice_ppp'))
						...
						if(isset($option_settings[0]))
							...
							if($option_settings[0]['submit_limit']>0)
								{
									...
									if($get_count==$option_settings[0]['submit_limit'])
										...
										if($option_settings[0]['submit_limit_msg'])
											{
											$output .= '<div class="v7_container form_type_'.$form_style.' '.$ms_back_disabled_class.' " style="'.(($background != 'use-form-background') ? $form_css_style : '').'">';
												$output .= '<div class="nf-limit-reached">'.$option_settings[0]['submit_limit_msg'].'</div>';
											$output .= '</div>';	
											}
							...
							if($option_settings[0]['form_expire'])
								{
									$tz = wp_timezone();
									//echo wp_date('Y/m/d H:i',time(),$tz).;
								$time_diff = strtotime($option_settings[0]['form_expire'])-strtotime(wp_date('Y/m/d H:i'));
								if($time_diff<=0)
									{
									if($option_settings[0]['submit_limit_msg'])
										{
						...
						$output .= '<div class="current_field_on_focus" style="display:none">1</div>';
							...
							$output .= 	'<form id="'.$id.'" class="'.$set_ajax.' nex-forms-'.$id.'" data-form-id="'.$id.'" name="nex_form" action="'.$set_post_action.'" method="'.$post_method.'" enctype="multipart/form-data">';
								...
								if(isset($_REQUEST['preview-form-id']))
									$output .= '<input type="hidden" name="nf_preview_id" value="'.sanitize_title($_REQUEST['preview-form-id']).'">';
								...
								$check_entry_redirect_update = isset($_GET['nf_entry_id']) ? sanitize_title(esc_attr($_GET['nf_entry_id'])) : false;
								//$check_entry_redirect_update = isset($_GET['nf_entry_redirect_id']) ? sanitize_text_field($_GET['nf_entry_redirect_id']) : false;
								if($check_entry_redirect_update)	
									$output .= '<input type="hidden" name="nf_entry_redirect_id" value="'.$check_entry_redirect_update.'">';
								...
								//$output .= '<div style="clear:both;"></div>';
								if(!get_option('nf_activated') && !get_option('nf_fs_activated'))
									$output .= ''.chr(80).chr(111).chr(119).chr(101).chr(114).chr(101).chr(100).' '.chr(98).chr(121).' <a href="https://basixonline.net/nex-forms/pricing/?utm_source=wordpress_fs&utm_medium=upgrade&utm_content=ui"">'.chr(78).chr(69).chr(88).chr(45).chr(70).chr(111).chr(114).chr(109).chr(115).'</a>';
	...
	$extra_script2 = '';
	if($open_trigger=="popup")
		$extra_script2 .= 'var get_modal = "enabled";';
	else
		$extra_script2 .= 'var get_modal = "disabled";';
	
	
		
	wp_add_inline_script('nex-forms-var', $extra_script2);
	
	if($open_trigger=="popup" || $open_trigger=="custom_trigger")
		wp_enqueue_script('nex-forms-modal');	
	...
	//wp_enqueue_style('nex-forms-bootstrap-5-ui');
	...
	//wp_enqueue_style('nex-forms-materialize', plugins_url( '/public/css/materialize-ui.css',__FILE__),'',$css_js_version, true);	
...
/*******************************************************************************************************/
	...
	$set_nex_forms_id = isset($_REQUEST['nex_forms_Id']) ? sanitize_title($_REQUEST['nex_forms_Id']) : '';
	$set_nex_forms_id = isset($_REQUEST['nf_preview_id']) ? sanitize_title($_REQUEST['nf_preview_id']) : $set_nex_forms_id;
	...
	if($entry_action)
		NEXForms_clean_echo( '<input type="hidden" name="nf_entry_update_id" value="'.sanitize_title(esc_attr($entry_id)).'">');
	
	if($form_attr->on_form_submission=='redirect')
		NEXForms_clean_echo( sanitize_title($entry_id));
	else
		NEXForms_clean_echo( '<input type="hidden" name="nf_entry_id" value="'.sanitize_title(esc_attr($entry_id)).'">');
...
/*******************************************************************************************************/
	...
	if($checked=='true' && (get_option('nf_activated') || get_option('nf_fs_activated')))
		{	
			...
			foreach($matches2[0] as $match)
				...
				if(is_array($_REQUEST[$nf_functions->format_name($match)]))
					...
					if(strstr($_REQUEST[$nf_functions->format_name($match)],'data:image') && $match!='{{nf_form_data}}')
						{
						$ftp_body = str_replace($match,'<img src="'.sanitize_text_field($_REQUEST[$nf_functions->format_name($match)]).'">',$ftp_body);	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						}
					else
						{	
...
';
			...
			$database_actions = new NEXForms_Database_Actions();
			$content = (get_option('nf_activated') || get_option('nf_fs_activated')) ? $content : 'Sorry, you need to activate this plugin to export entries to CSV. Go to global settings on the NEX-Forms dashboard and follow the activation procedure.';
...
function NEXForms_dashboard_2(){
	...
	NEXForms_clean_echo( '
	  <div id="pfd_creator_not_installed" class="modal">
		...
		<div class="modal-content">
		  <p>Printing form entries to PDF requires <a href="https://basixonline.net/nex-forms/pricing/?utm_source=wordpress_fs&utm_medium=upgrade&utm_content=feature_unlock"">PDF Creator for NEX-Forms</a></p>
		</div>
		<div class="modal-footer">
		  <a href="#!" data-bs-dismiss="modal" data-dismiss="modal" class="modal-action modal-close waves-effect waves-green btn-flat">Close</a>
		</div>
	  </div> 
  	'); 
		  ...
		  $output .= '<div id="add_ons_panel" class="dashboard_panel" style="display:none">';
			  $output .= '<div class="row">';
				...
				if($download && $diff>0)
					...
					{
					if(!get_option('nf_activated') && !get_option('nf_fs_activated'))
						$output .= '<div class="row"><div class="col-sm-12"><div class="alert alert-info"><h3>SALE NOW ON!</h3>We are celebrating 12 000+ Sales! <a href="https://basixonline.net/nex-forms/pricing/?utm_source=wordpress_fs&utm_medium=upgrade&utm_content=feature_unlock"">Buy NEX-forms today</a> and all these add-ons worth $300 absolutely FREE!.</div></div></div>';
					}
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/zapier-integration/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-zapier.png', __FILE__).'"></a>';	 // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						...
						$output .= '<div class="add_on_check">';	
							...
							if(function_exists('NEXForms_not_found_notice_zapier'))
								...
								{
								$output .= '<a href="https://basixonline.net/nex-forms/pricing/?utm_source=wordpress_fs&utm_medium=upgrade&utm_content=feature_unlock"" class="buy_add_on btn btn-lime" target="_blank">Get Add-on</a>';	
								}
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/form-themes/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-form-themes.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/paypal-pro/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-paypal-pro.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/pdf-creator/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-pdf-creator.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/super-select-form-field/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-super-select.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/mailchimp/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-mailchimp.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/mailchimp/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-mailster.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/mailchimp/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-mailpoet.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/getresponse/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-getresponse.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/digital-signatures/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-digital-signatures.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/form-to-post-or-page/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-form-to-post-or-page.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a  href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/conditional-content-blocks/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-conditional-content-blocks.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
				...
				$output .= '<div class="col-sm-2">';
					$output .= '<div class="add_on_item">';	
						$output .= '<div class="add_on_cover">';
							$output .= '<a href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/add-ons/shortcode-processor/" target="_blank"><img src="'.plugins_url('/admin/images/add-ons/covers/nex-forms-add-on-shortcode-processor.png', __FILE__).'"></a>';	// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						$output .= '</div>';
						$output .= '<div class="add_on_desciprtion">';	
	...
	$output .= '<div class="builder-footer">';
			...
			$output .= '
			'.(($theme->Name=='NEX-Forms Demo') ? '<a href="https://basixonline.net/nex-forms/pricing/?utm_source=wordpress_fs&utm_medium=upgrade&utm_content=feature_unlock"" target="_blank" class="btn waves-effect waves-light upgrade_pro animated fadeInRight">BUY NEX-FORMS</a>' : '' ).'
	...
	foreach($wp_styles->registered as $wp_style=>$array)
		...
		if(!in_array($array->handle,$include_style_array) && !strstr($array->handle,'nex-forms'))
			{
			NEXForms_clean_echo( esc_html('<div class="unwanted_css">'.$array->handle.'-css</div>'));
			}
		}	
...
function NEXForms_form_builder(){
		...
		NEXForms_clean_echo( '<div id="nex-forms" class="nf-admin">');
		NEXForms_clean_echo( '<ul id="nav" class="tiny_button_tags_placeholders" style="position: absolute; z-index: 150000;"></ul>');
		 NEXForms_clean_echo( '<div class="nex_forms_admin_page_wrapper">');
		  ...
		  NEXForms_clean_echo( '</div>');
		   ...
		   NEXForms_clean_echo( $builder->builder7_top_menu());
		   
			NEXForms_clean_echo( '<div id="" class="builder-content-section">');
			
				NEXForms_clean_echo( '<div class="dash-left-col">');
				
				NEXForms_clean_echo( '<div class="top-menu-dropdown2"><ul class="aa_menu tabs_nf2">');
								
									
										//NEXForms_clean_echo( '<li class="db_tab '.(($_REQUEST['page']=='nex-forms-dashboard') ? 'current' : '').'"><a href="'.get_admin_url().'admin.php?page=nex-forms-dashboard" data-title="'.__('Dashboard','nex-forms').'" class="'.(($_REQUEST['page']=='nex-forms-dashboard') ? 'current' : '').' submissions_tab"><span class="top-icon fas fa-home"></span> <span class="menu-text">'.__('Dashboard','nex-forms').'</span></a></li>');
										
										NEXForms_clean_echo( '<li class="db_tab tab alt-tab current"><a class="canvas_view workspace normal" data-screen="builder_view" href="#builder_view"><span class="top-icon fa-solid fa-file-pen"></span><span class="menu-text">'.__('Form Editor','nex-forms').'</span></a></li>');
										
										NEXForms_clean_echo( '<li class="alt-tab"><a class="canvas_view workspace success-msg" href="#builder_view" data-screen="builder_view"><span class="top-icon fa-solid fa-file-circle-check"></span><span class="menu-text">'.__('Success Message','nex-forms').'</span></a></li>');
										NEXForms_clean_echo( '<li class="alt-tab"><a class="canvas_view workspace c-logic" href="#builder_view" data-screen="builder_view"><span class="top-icon fas fa-random"></span><span class="menu-text">'.__('Conditional Logic','nex-forms').'</span></a></li>');
										
										NEXForms_clean_echo( '<li class="db_tab tab"><a href="#email_setup" class="email_setup" data-screen="email_setup"><span class="top-icon fas fa-envelope"></span><span class="menu-text">'.__('Email Autoresponders','nex-forms').'</span></a></li>');
										NEXForms_clean_echo( '<li class="db_tab tab"><a href="#form_integration" class="integration" data-screen="form_integration"><span class="top-icon fas fa-code-branch fa-rotate-90"></span><span class="menu-text">'.__('Integrations','nex-forms').'</span></a></li>');
										NEXForms_clean_echo( '<li class="db_tab tab"><a href="#form_options" class="form_options" data-screen="form_options"><span class="top-icon fas fa-cog"></span><span class="menu-text">'.__('Extra Form Options','nex-forms').'</span></a></li>');
										NEXForms_clean_echo( '<li class="db_tab tab"><a href="#embed_options" class="embed_options" data-screen="embed_options"><span class="top-icon fas fa-code"></span><span class="menu-text">'.__('Embed','nex-forms').'</span></a></li>');
								
								
							   NEXForms_clean_echo( '</ul></div>');
				
				NEXForms_clean_echo( '</div>');
				
			NEXForms_clean_echo( '<div class="dash-right-col">');
					NEXForms_clean_echo( '<div id="builder_view" class="nf-screen">');
						 NEXForms_clean_echo( $builder->print_form_canvas());
					NEXForms_clean_echo( '</div>');
		
					NEXForms_clean_echo( '<div id="email_setup" class="hidden_onload nf-screen extra_form_attr hidden">');
						$builder->print_email_setup();
					NEXForms_clean_echo( '</div>');
					
					NEXForms_clean_echo( '<div id="form_integration" class="hidden_onload nf-screen extra_form_attr hidden">');
						$builder->print_integration_setup();
					NEXForms_clean_echo( '</div>');
					
					NEXForms_clean_echo( '<div id="form_options" class="hidden_onload nf-screen extra_form_attr hidden">');
						$builder->print_options_setup();
					//NEXForms_clean_echo( '</div>');
					
					NEXForms_clean_echo( '<div id="embed_options" class="hidden_onload nf-screen extra_form_attr hidden">');
...
function NEXFORMS_validate_email($email){
	if(!$email)
		return true;
      ...
      if(checkdnsrr(array_pop(explode("@",$email)),"MX"))
		...
		NEXForms_clean_echo( '<div class="alert alert-danger">Email address does not exist! No attempt was made to sent an email to this address: <strong>'.esc_html(sanitize_text_field($email)).'</strong><br /><br />Please resend the form using a real and valid email address.</div>');
        return false;
      } 
}
...
function nf_send_mail($nex_forms_id='', $entry_id='', $resent=0,$send_email=true, $files=array(), $checked=false, $files_array=array()){
						...
						if(is_array($val))
										...
										foreach($value as $innerkey=>$innervalue)
											...
											if(!strstr($innerkey,'real_val__') && $nf_functions->unformat_name($innerkey)!='Undefined')
												...
												if(in_array($nf_functions->get_ext($innervalue),$img_ext_array))
													$admin_val .= '<td style="border-right:1px solid #ddd;"><span style="max-width:100px;"><img src="'.rtrim($innervalue,', ').'" style="max-width:100px;" /></span></td>'; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
												else
							...
							if($admin_val!='')
								...
								if(strstr($admin_val,'data:image'))
									$admin_val = '<img src="'.$admin_val.'" />'; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
								...
								if(strstr($admin_val,'||'))
									...
									foreach($get_val as $setkey=>$setval)
										...
										if(in_array($nf_functions->get_ext(trim($setval)),$img_ext_array))
											$set_val .= '<a href="'.$setval.'" target="_blank"><span style="max-width:100px;"><img src="'.$setval.'"></span></a><br />'; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage									
										else
	...
	/*******************************************************************************************************/
		...
		$_REQUEST['nf_from_page'] 				= sanitize_text_field($_POST['page']);
		...
		$_REQUEST['nf_form_id'] 				= sanitize_title($_POST['nex_forms_Id']);
		$_REQUEST['nf_entry_id']				= sanitize_title(esc_attr($entry_id));
		...
		preg_match_all($pattern, $body, $matches);
			...
			foreach($matches[0] as $match)
				...
				if(is_array($_REQUEST[$nf_functions->format_name($match)]))
							...
							if($k==1)
										...
										foreach($value as $innerkey=>$innervalue)
											...
											if(!strstr($innerkey,'real_val__') && $nf_functions->unformat_name($innerkey)!='Undefined')
												{
												if(in_array($nf_functions->get_ext($innervalue),$img_ext_array))
													$the_val .= '<td style="border-right:1px solid #ddd;max-width:100px; width:100px;"><span style="max-width:100px; width:100px;"><img src="'.rtrim($innervalue,', ').'" style="max-width:100px;" width="100" /></span></td>'; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
												else
					...
					if(strstr($_REQUEST[$nf_functions->format_name($match)],'data:image') && $match!='{{nf_form_data}}')
						{
						$body = str_replace($match,'<img src="'.$_REQUEST[$nf_functions->format_name($match)].'">',$body);	 // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						}
					else
						{
		...
		preg_match_all($pattern, $admin_body, $matches2);
			...
			foreach($matches2[0] as $match)
				...
				if(is_array($_REQUEST[$nf_functions->format_name($match)]))
					...
					if(strstr($_REQUEST[$nf_functions->format_name($match)],'data:image') && $match!='{{nf_form_data}}')
						{
						$admin_body = str_replace($match,'<img src="'.$_REQUEST[$nf_functions->format_name($match)].'">',$admin_body);	 // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
						}
					else
						{
						if($_REQUEST[$nf_functions->format_name($match)]!='--- Select ---')
		...
		//SETUP EMAIL FORMAT
		$message = $admin_body;
		if(NEXFORMS_validate_email($_REQUEST[$form_attr->user_email_field])) 
			$send_user_email = esc_html(sanitize_text_field($_REQUEST[$form_attr->user_email_field]));	
		else
...
if($checked=='false' || (!get_option('nf_activated') && !get_option('nf_fs_activated')))
	...
	if($email_config['email_method']=='smtp' || $email_config['email_method']=='php_mailer')
		...
		if($send_user_email)
			...
			if($send_email)
				...
				if (!$confirmation_mail->send())
					{
					NEXForms_clean_echo( '<div class="alert alert-danger"><strong>'.__('Confirmation Mailer Error:','nex-forms').'</strong> ' . $confirmation_mail->ErrorInfo.'</div>');
					} 
				}
			}
		...
		if($send_admin_email=='true')
			...
			if($attach_to_admin_email=='true')
				...
				if($send_email)
					...
					if(!$mail->send())	
						{
						NEXForms_clean_echo( '<div class="alert alert-danger"><strong>'.$reply_to.__('Admin Mailer Error:','nex-forms').'</strong> ' . $mail->ErrorInfo.'</div>');
						}
					}
			}
		}
		...
		/**************************************************/
			...
			{
			NEXForms_clean_echo( 'ERROR: No Mail Method Config Setup->'.$email_config['email_method']);
			}
...
/* UI STYLE REGISTRATION */		
	if($styles_config['incstyle-font-awesome']=='1' || !array_key_exists('incstyle-font-awesome',$styles_config))
		{
		//wp_register_style('nex-forms-font-awesome-5',plugins_url( '/public/css/fa5/css/all.min.css',__FILE__),'',$css_js_version, true);
		//wp_register_style('nex-forms-font-awesome-4-shims',plugins_url( '/public/css/fa5/css/v4-shims.min.css',__FILE__),'',$css_js_version, true);
		
		wp_register_style('nex-forms-font-awesome-6',plugins_url( '/public/css/fa6/css/all.min.css',__FILE__),'',$css_js_version);
		wp_register_style('nex-forms-font-awesome-4-shims',plugins_url( '/public/css/fa6/css/v4-shims.min.css',__FILE__),'',$css_js_version);
		wp_register_style('nex-forms-font-awesome-5-shims',plugins_url( '/public/css/fa6/css/v5-font-face.min.css',__FILE__),'',$css_js_version);
	...
	//wp_register_style('nex-forms-bootstrap-5-ui', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js','',$css_js_version);
...
/* UI SCRIPT REGISTRATION */
	if($script_config['inc-bootstrap']=='1' || !$script_config['inc-bootstrap'])
		wp_register_script('nex-forms-bootstrap.min',  plugins_url( '/public/js/min/bs.min.js',__FILE__),'',$css_js_version, true);
	if($script_config['inc-wow']=='1' || !$script_config['inc-wow'])
		wp_register_script('nex-forms-wow',  plugins_url( '/libs/wow.min.js',__FILE__),'',$css_js_version, true);
	if($script_config['inc-raty']=='1' || !$script_config['inc-raty'])
		wp_register_script('nex-forms-raty-fa',  plugins_url( '/public/js/min/jquery.raty-fa.js',__FILE__),'',$css_js_version, true);
	
	wp_register_script('nex-forms-modal',  plugins_url( '/libs/nf-modal.js',__FILE__),'',$css_js_version, true);	
	
	wp_register_script('nex-forms-selects-js',  plugins_url( '/libs/nex-select.js',__FILE__),'',$css_js_version, true);	
	wp_register_script('nex-forms-var',  plugins_url( '/public/js/min/var.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-input-mask',  plugins_url( '/public/js/min/jquery.inputmask.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-sigs',  plugins_url( '/public/js/min/jquery.sig.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-tags',  plugins_url( '/public/js/min/jquery.tags.js',__FILE__),'',$css_js_version, true);
	
	wp_register_script('nex-forms-timer',  plugins_url( '/public/js/min/jquery.timer.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-materialize.min',  plugins_url( '/libs/materialize.min.js',__FILE__),'',$css_js_version, true);
	
	
	
	wp_register_script('nex-forms-onload', plugins_url( '/public/js/'.NF_PATH.'nexf-onload-ui.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-math.min',  plugins_url( '/libs/math.min.js',__FILE__),'',$css_js_version, true);
	
	wp_register_script('nex-forms-moment.min', plugins_url( '/libs/moment.min.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-locales.min', plugins_url( '/libs/moment.min.js',__FILE__),'',$css_js_version, true);
	wp_register_script('nex-forms-bootstrap-datetimepicker', plugins_url( '/public/js/'.NF_PATH.'bootstrap-datetimepicker.js',__FILE__),'',$css_js_version, true);
	
	wp_register_script('nex-forms-bootstrap-touchspin', plugins_url( '/public/js/min/jquery.bootstrap-touchspin.js',__FILE__),'',$css_js_version, true);
...
function nf_add_action_links( $actions, $plugin_file ) {
		...
		$action_links           = array(
			...
			' docs'     => array(
				...
				'url'   => 'https://basixonline.net/nex-forms-docs/',
			),
			/*'nf-pp add-ons'     => array(
				'label' => __( '<span class="dashicons-before dashicons-download"></span> Add-ons Download', 'nex-forms' ),
				'url'   => 'https://basixonline.net/nex-forms-free-add-ons-download/',
			),*/
		...
		if ( !get_option('nf_activated') && !get_option('nf_fs_activated') ) {
			...
			$action_links['nf_activate_license'] =
				array(
					'label' => __( 'Activate License', 'nex-forms' ),
					'url'   => get_admin_url().'admin.php?page=nex-forms',

				);
			$action_links['nf_upgrade_premium'] =
				array(
					'label' => __( 'Upgrade to PREMIUM', 'nex-forms' ),
					'url'   => 'https://basixonline.net/nex-forms/pricing/?utm_source=wordpress_fs&utm_medium=upgrade&utm_content=feature_unlock"',
...
global $wp_meta_boxes;
 if ( !get_option('nf_activated') && !get_option('nf_fs_activated')) {
	...
	wp_add_dashboard_widget('nex_forms_widget', 'NEX-Forms '.date('F').' Special', 'nex_forms_dashboard');
 }
}
