...
function get_input_settings(){
	...
	jQuery('.setting-device-only button').addClass('active');
	if(current_field.hasClass('nf-no-mobile'))
		jQuery('.setting-device-only button.set-mobile').removeClass('active');
	if(current_field.hasClass('nf-no-tablet'))
		jQuery('.setting-device-only button.set-tablet').removeClass('active');
	if(current_field.hasClass('nf-no-laptop'))
		jQuery('.setting-device-only button.set-laptop').removeClass('active');
	if(current_field.hasClass('nf-no-pc'))
		jQuery('.setting-device-only button.set-pc').removeClass('active');
...
//GET SELECT SETTINGS	
	...
	//GET OPTIONS
		...
		current_field.find('select').children().each(function() {
				...
				else if (jQuery(this).is('optgroup')) {
                    // Append the group label
                    current_options += '[group]' + jQuery(this).attr('label') + '\n';
	...
	jQuery('.select-search button').removeClass('active');
	if(current_field.find('select').attr('data-select-search')=='yes')
		jQuery('.select-search button.select-search-yes').addClass('active');
	else
		jQuery('.select-search button.select-search-no').addClass('active');	
...
//RESET RADIO COLORS
	...
	jQuery(".set-radio-bgc-color-uc").spectrum("set",'#ffffff');
	jQuery(".set-radio-bgc-color").spectrum("set",'#0d6efd');
...
//GET INPUT RADIO COLOR	
	jQuery(".set-radio-text-color").spectrum("set", current_field.find('span.check-icon').css('color'));	
//GET INPUT RADIO BACKGOUND COLOR	
	
	var label_size = current_field.find('span.input-label').css('font-size');
	jQuery( "#set_radio_label_size" ).val(label_size.replace('px',''))	
	jQuery("#set_radio_label_size").bind('keyup input', function(){
		current_field.find('span.input-label').css('font-size',jQuery(this).val()+'px');
		//current_field.find('span.input-label').css('line-height',(jQuery(this).val()+2)+'px');
	});	
    ...
    if(current_field.find('.the-radios').attr('data-checked-bg-color'))
	 ...
	 if(current_field.find('.the-radios').attr('data-checked-icon-color'))
		jQuery(".set-radio-text-color").spectrum("set", current_field.find('.the-radios').attr('data-checked-icon-color') );
	
	
	if(current_field.find('.the-radios').attr('data-checked-bg-color-uc'))
		jQuery(".set-radio-bgc-color-uc").spectrum("set", current_field.find('.the-radios').attr('data-checked-bg-color-uc') );
...
//GET PANEL SETTINGS
	...
	//Panel heading text aling
		...
		jQuery('div.field-settings-column #set_panel_id').val(current_field.find('.panel').attr('data-panel-id'));
...
//GET RADIO SIZE
	jQuery('.radio-check-size button').removeClass('active');
	if(current_field.find('#the-radios').hasClass('radio-lg'))
		jQuery('.radio-check-size button.large').addClass('active');
	else if(current_field.find('#the-radios').hasClass('radio-sm'))
		jQuery('.radio-check-size button.small ').addClass('active');
	else
		jQuery('.radio-check-size button.normal').addClass('active');
...
jQuery('#set_math_input_name').val(format_illegal_chars(current_field.find('.set_math_result').attr('name')))
	...
	jQuery("#html_field_spacing_margin_top").bind('keyup input', function(){
		current_field.find('#field_container').css('margin-top',jQuery(this).val()+'px');
	});	
	...
	jQuery("#html_field_spacing_margin_right").bind('keyup input', function(){
		current_field.find('#field_container').css('margin-right',jQuery(this).val()+'px');
	});	
	...
	jQuery("#html_field_spacing_margin_bottom").bind('keyup input', function(){
		current_field.find('#field_container').css('margin-bottom',jQuery(this).val()+'px');
	});	
...
*/
	...
	jQuery("#html_field_spacing_margin_left").bind('keyup input', function(){
		current_field.find('#field_container').css('margin-left',jQuery(this).val()+'px');
	});
...
//PADDING
	...
	jQuery("#html_field_spacing_padding_top").bind('keyup input', function(){
	...
	jQuery("#html_field_spacing_padding_right").bind('keyup input', function(){
	...
	*/	
	...
	jQuery("#html_field_spacing_padding_bottom").bind('keyup input', function(){
	...
	*/
	...
	jQuery("#html_field_spacing_padding_left").bind('keyup input', function(){
...
function get_validation_settings(){
	...
	jQuery('div.field-settings-column #set_max_word_val').val(input_element.attr('data-max-words'))
	jQuery('div.field-settings-column #set_min_word_val').val(input_element.attr('data-min-words'))
	
	jQuery('div.field-settings-column #set_input_mask').val(input_element.attr('data-input-mask'))
	
	
	jQuery('#text_transform option').each(
		function()
			{
			if(input_element.attr('data-text-transform')==jQuery(this).attr('value'))
...
function get_extra_settings(){
	...
	var field_wrapper_border_width 		= (current_field.css('border-width')) ? current_field.css('border-width') : '0';
	var set_field_wrapper_border_width 	= field_wrapper_border_width.replace('px','');
	
	var field_wrapper_border_radius 		= (current_field.css('border-radius')) ? current_field.css('border-radius') : '0';
	var set_field_wrapper_border_radius 	= field_wrapper_border_radius.replace('px','');
		
		

	jQuery( "#fw-brd-size" ).val(set_field_wrapper_border_width)
	jQuery("#fw-brd-size").bind('keyup input', function(){
			current_field.css('border-width',jQuery(this).val()+'px');
		});	
	
	jQuery( "#fw-brd-radius" ).val(set_field_wrapper_border_radius)	
		jQuery("#fw-brd-radius").bind('keyup input', function(){
			current_field.css('border-radius',jQuery(this).val()+'px');
		});	
...
//MARGIN
	...
	jQuery("#field_spacing_margin_top").bind('keyup input', function(){
		current_field.css('margin-top',jQuery(this).val()+'px');
	});	
	...
	jQuery("#field_spacing_margin_right").bind('keyup input', function(){
		current_field.css('margin-right',jQuery(this).val()+'px');
	});
	...
	*/		
	...
	jQuery("#field_spacing_margin_bottom").bind('keyup input', function(){
		current_field.css('margin-bottom',jQuery(this).val()+'px');
	});
	...
	*/
	...
	jQuery("#field_spacing_margin_left").bind('keyup input', function(){
		current_field.css('margin-left',jQuery(this).val()+'px');
	});
...
//PADDING
	...
	jQuery("#field_spacing_padding_top").bind('keyup input', function(){
		current_field.find('#field_container').css('padding-top',jQuery(this).val()+'px');
	});
	/*jQu
	...
	jQuery("#field_spacing_padding_right").bind('keyup input', function(){
		current_field.find('#field_container').css('padding-right',jQuery(this).val()+'px');
	});
	...
	*/		
	...
	jQuery("#field_spacing_padding_bottom").bind('keyup input', function(){
		current_field.find('#field_container').css('padding-bottom',jQuery(this).val()+'px');
	});
	...
	*/
	...
	jQuery("#field_spacing_padding_left").bind('keyup input', function(){
		current_field.find('#field_container').css('padding-left',jQuery(this).val()+'px');
	});
...
//Border radius
	...
	jQuery(".fw-bg-color").spectrum("set", current_field.css('background'));
	jQuery(".fw-brd-color").spectrum("set", current_field.css('border-top-color'));
	...
	jQuery("." + trigger).spectrum(
		{
		 ...
		 move: function(color) {
			...
			if(strstr(target,'data'))
				{
				if(target=='data-checked-bg-color')
					{
				...
				if(target=='data-checked-bg-color-uc')
					{
					current_field.find('#the-radios').attr('data-checked-bg-color-uc',jQuery(this).val())
					current_field.find('#the-radios a:not(.checked)').css('background-color',jQuery(this).val())
					}
				if(target=='data-checked-icon-color')
					{
					current_field.find('#the-radios').attr('data-checked-icon-color',jQuery(this).val())
					current_field.find('span.check-icon').css('color',jQuery(this).val())
					}
...
function get_overall_form_settings(get_target){
	...
	jQuery(document).on('click','.reset-form-padding',
		function()
			{
			jQuery( "#form_padding_top" ).val('30').trigger('keyup');
			jQuery( "#form_padding_right" ).val('30').trigger('keyup');
			jQuery( "#form_padding_bottom" ).val('30').trigger('keyup');
			jQuery( "#form_padding_left" ).val('30').trigger('keyup');
			jQuery( "#form_padding" ).val('30').trigger('keyup');
			}
		);	
	
	jQuery(document).on('click','.reset-form-margins',
		function()
			{
			jQuery( "#form_margin_top" ).val('0').trigger('keyup');
			jQuery( "#form_margin_right" ).val('0').trigger('keyup');
			jQuery( "#form_margin_bottom" ).val('0').trigger('keyup');
			jQuery( "#form_margin_left" ).val('0').trigger('keyup');
			}
		);	
	...
	jQuery("#form_margin_top").bind('keyup input', function(){
	...
	jQuery("#form_margin_right").bind('keyup input', function(){
	...
	*/		
	...
	jQuery("#form_margin_bottom").bind('keyup input', function(){
	...
	*/
	...
	jQuery("#form_margin_left").bind('keyup input', function(){
	...
	*/	
	...
	jQuery("#form_padding_top").bind('keyup input', function(){
	...
	*/		
	...
	jQuery("#form_padding_right").bind('keyup input', function(){
	...
	*/		
	...
	jQuery("#form_padding_bottom").bind('keyup input', function(){
	...
	*/
	...
	jQuery("#form_padding_left").bind('keyup input', function(){
