...
function()
	...
	var special_run = new Tour({
		  name: "2025-special-04-08",
		  onStart: function(){ },
		  onEnd: function(){ special_run2.end(); },
		  steps: [
		  {
			orphan: true,
			title: "SPECIAL NOW ON!<br><br><span class='do_highlight2'>SAVE $300!</span>",
			...
			content: "<div class='new_tut' style=\"line-height: 23px;\">Buy NEX-Forms today and  <strong style=\"color:#9315bd ;\">GET All ADD-ONS FOR FREE</h5></strong> worth $300</span><span class='tip' style=\"font-size: 18px;line-height: 25px !important;margin-bottom: 0px;\">A<strong style=\"color:#9315bd ;\"> ONCE-OFF PRICE</strong> of <strong style=\"color:#9315bd ;\">ONLY $49</strong><br> Includes <strong style=\"color:#9315bd ;\">LIFETIME FREE UPDATES</strong> for all items and <strong style=\"color:#9315bd ;\">SUPPORT!</strong></span></div>",
			...
			template: "<div class='popover tour tutorial-step-1'><div class='popover-arrow'></div><h3 class='popover-title'></h3><div class='popover-content'></div><span class='tip' style=\"font-size:15px;line-height: 26px !important;\"><strong style='font-weight:bold;'>FREE ADD-ONS INCLUDE:<br></strong>Multi-Page Forms &bull; Zapier Integration &bull; PayPal PRO &bull; PDF Creator &bull; Digital Signatures <br> Form Themes &bull; Form to Post/Page &bull; Conditional Content Blocks &bull; Shorcode Processor <br> PayPal Classic &bull; Super Select Form Fields &bull; MailChimp &bull; MailPoet &bull; Mailster &bull; GetResponse</span><div class='popover-navigation'><a href=\"https://1.envato.market/zQ6de\" target=\"_blank\" class=\"btn-hs btn-2\">BUY NOW and SAVE $300!</a><button class='end-tour' data-role='end'><span class='fa fa-close'></span></button><span class='tip'><strong>EASY UPGRADE:</strong><br>&bull; When upgrading you will unlock all features and get all add-ons free. <br>&bull; All your saved forms, data and settings will remain unchanged. <br>&bull; NO WORK LOSS will occur and NO REDO'S will be needed when upgrading/updating.</span><em><br>Offer valid for a limited time only!</em></div>",
