...
function()
	...
	var special_run = new Tour({
		  name: "2024-special-12-02",
		  onStart: function(){ },
		  onEnd: function(){ special_run2.end(); },
		  steps: [
		  {
			orphan: true,
			title: "SPECIAL NOW ON!<br><br><span class='do_highlight2'>SAVE $280!</span>",
