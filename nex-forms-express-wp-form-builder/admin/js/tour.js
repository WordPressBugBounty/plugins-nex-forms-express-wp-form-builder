...
var whats_new = new Tour({
		  ...
		  {
			element: ".dash-left-col",
			title: "Main Menu",
			content: "The main menu have moved from the top to here on the left hand side.",
			placement: 'right'
		  },
		  
		  {
			element: ".prime-preview.preview",
			title: "Full Form Preview",
			content: "Full Form Preview Mode have moved here.",
			placement: 'bottom'
		  },
		  
		  {
			element: ".canvas_view.workspace.success-msg",
			title: "Success Message Editor",
			content: "The Success Message editor can now be found here from the main menu items.",
			placement: 'right'
		  },
		  {
			element: ".canvas_view.workspace.c-logic",
			title: "Conditional Logic",
			content: "Conditional Logic setup can now be found here from the main menu items.",
			placement: 'right'
		  },
		  ...
		  */
		  {
			orphan: true,
			title: "That's it the Whats New Tour",
			content: "Also See: <br><br><a href='#' class='kbsc-tut'>Keyboard Shortcuts</a><br><a href='#' class='tour-main'>Main Tour</a></div>",
...
jQuery(document).on('click','.tour-whats-new',
		function()
			{
			end_nf_tours();
			jQuery('a.canvas_view.normal').trigger('click');
			whats_new.init();
			whats_new.restart();
			whats_new.goTo(0) 
			}
		  ...
		  steps: [
				  {
					...
					title: "SPECIAL OFFER!!!",
					content: "Buy NEX-Forms today and get all 14 add-ons worth $280 for FREE!<strong></strong>!<a href='https://basixonline.net/nex-forms/pricing/' target='_blank' class='start-button'><span class='start-border'>Buy Now</span><span class='start-border-2 pulsate_1'></a>",
...
/* SETUP EMAILS */
	var email_setup_tour = new Tour({
		  ...
		  {
			element: ".tut_admin_email_7",
			title: "Send Admin Email",
			content: "Sets to send the admin email or not upon form submission.",
			placement: 'bottom'
		  },
		  {
		  ...
		  {
			element: ".tut_admin_email_8",
			title: "Reply-To",
			content: "Sets the reply address. Right click to insert an Email Field's data from your available form fields.",
			placement: 'bottom'
		  },
		  {
...
/* SETUP PAYPAL */
	...
	jQuery(document).on('click','.tour-paypal-setup',
		function()
			{
			end_nf_tours();
			jQuery('.top-menu-dropdown2 a.integration').trigger('click');
...
/* On Form Submission */
	...
	jQuery(document).on('click','.tour-form-submit-setup',
		function()
			{
			end_nf_tours();
			jQuery('.top-menu-dropdown2 a.form_options').trigger('click');
...
/* MAIN TOUR */	
	var main_tour = new Tour({
		  ...
		  },*/
		  {
			element: "#form_name",
			title: "Form Title",
			content: "This is the Title of your form and you can edit it from here.",
			placement: 'bottom'
		  },
		  ...
		  
		  {
			element: ".prime-preview.preview",
			title: "Full Form Preview",
			content: "Click for a full screen preview of your form.",
			placement: 'bottom'
		  },
		  ...
		  {
			element: "a.canvas_view.normal",
			title: "Form Builder",
			content: "Click here to build and style your form.",
			placement: 'right',
		  },
		  {
			element: "a.canvas_view.success-msg",
			title: "Success Message Builder",
			content: "Click here to build and style your on-screen success message.",
			placement: 'right',
		  },
		  {
			element: "a.canvas_view.workspace.c-logic",
			title: "Conditional Logic",
